...
from ..models.connection_competitive_entry_type import ConnectionCompetitiveEntryType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.connection_assigned_server_type_0 import ConnectionAssignedServerType0
    from ..models.connection_machine import ConnectionMachine


T = TypeVar("T", bound="ConnectionCompetitiveEntry")


@_attrs_define
class ConnectionCompetitiveEntry:
    """
    Attributes:
        type_ (ConnectionCompetitiveEntryType):
        available (bool):
        location_type_friendly (None | str | Unset):
        assigned_server (ConnectionAssignedServerType0 | None | Unset):
        machine (ConnectionMachine | Unset):
    """
    ...
    machine: ConnectionMachine | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = ConnectionCompetitiveEntryType(d.pop("type"))
        ...
        if isinstance(_machine, Unset):
            ...
            machine = ConnectionMachine.from_dict(_machine)

        connection_competitive_entry = cls(
            type_=type_,
            available=available,
        ...
        connection_competitive_entry.additional_properties = d
        return connection_competitive_entry
