...
from ..models.connection_lab_entry_type import ConnectionLabEntryType
...
T = TypeVar("T", bound="ConnectionLabEntry")


@_attrs_define
class ConnectionLabEntry:
    """
    Attributes:
        type_ (ConnectionLabEntryType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = ConnectionLabEntryType(d.pop("type"))
        ...
        connection_lab_entry = cls(
            type_=type_,
            location_type_friendly=location_type_friendly,
            assigned_server=assigned_server,
        )

        connection_lab_entry.additional_properties = d
        return connection_lab_entry
