...
from ..models.connection_pro_lab_entry_type import ConnectionProLabEntryType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.connection_assigned_server_type_0 import ConnectionAssignedServerType0
    from ..models.connection_prolab import ConnectionProlab


T = TypeVar("T", bound="ConnectionProLabEntry")


@_attrs_define
class ConnectionProLabEntry:
    """
    Attributes:
        type_ (ConnectionProLabEntryType):
        pro_lab (ConnectionProlab):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = ConnectionProLabEntryType(d.pop("type"))

        pro_lab = ConnectionProlab.from_dict(d.pop("pro_lab"))
        ...
        connection_pro_lab_entry.additional_properties = d
        return connection_pro_lab_entry
