...
T = TypeVar("T", bound="UserApptokenListItem")


@_attrs_define
class UserApptokenListItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_apptoken_list_item.additional_properties = d
        return user_apptoken_list_item
