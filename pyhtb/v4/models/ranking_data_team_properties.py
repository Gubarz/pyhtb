...
T = TypeVar("T", bound="RankingDataTeamProperties")


@_attrs_define
class RankingDataTeamProperties:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ranking_data_team_properties = cls(
        ...
        ranking_data_team_properties.additional_properties = d
        return ranking_data_team_properties
