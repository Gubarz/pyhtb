...
T = TypeVar("T", bound="SeasonPlatersLeaderboardTopDataItem")


@_attrs_define
class SeasonPlatersLeaderboardTopDataItem:
    """
    Attributes:
        avatar_thumb (None | str | Unset):
        country (None | str | Unset):
        is_respected (bool | Unset):
        last_own (None | str | Unset):
        league_rank (str | Unset):
        name (str | Unset):
        points (float | Unset):
        rank (float | Unset):
        resource_id (int | Unset):
        root_bloods (float | Unset):
        root_owns (float | Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        last_own: None | str | Unset
        if isinstance(self.last_own, Unset):
            last_own = UNSET
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_last_own(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        last_own = _parse_last_own(d.pop("last_own", UNSET))
        ...
        season_platers_leaderboard_top_data_item = cls(
        ...
        season_platers_leaderboard_top_data_item.additional_properties = d
        return season_platers_leaderboard_top_data_item
