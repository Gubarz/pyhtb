...
T = TypeVar("T", bound="RankingsItem")
...
class RankingsItem:
    ...
    ranks_diff: float | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_ranks_diff(data: object) -> float | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        rankings_item.additional_properties = d
        return rankings_item
