...
T = TypeVar("T", bound="OfficialWriteup")


@_attrs_define
class OfficialWriteup:
    """
    Attributes:
        filename (str | Unset):
        sha256 (None | str | Unset):
        url (str | Unset):
        video_url (None | str | Unset):  Example: https://www.youtube.com/watch?v=bv08UcIL1po.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        official_writeup.additional_properties = d
        return official_writeup
