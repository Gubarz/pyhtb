...
T = TypeVar("T", bound="RankingsCountriesItem")


@_attrs_define
class RankingsCountriesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rankings_countries_item.additional_properties = d
        return rankings_countries_item
