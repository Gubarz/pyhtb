...
T = TypeVar("T", bound="ConnectionsServersProlabData")


@_attrs_define
class ConnectionsServersProlabData:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        connections_servers_prolab_data = cls(
            assigned=assigned,
            options=options,
        )

        connections_servers_prolab_data.additional_properties = d
        return connections_servers_prolab_data
