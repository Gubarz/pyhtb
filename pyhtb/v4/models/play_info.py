...
T = TypeVar("T", bound="PlayInfo")


@_attrs_define
class PlayInfo:
    """Schema definition for Play Info

    Attributes:
        active_player_count (int | Unset):  Example: 1.
    ...
    active_player_count: int | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        play_info.additional_properties = d
        return play_info
