...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/challenges/{challenge_id}/download_link".format(
...
) -> Message | SherlockDownloadLink | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Message | SherlockDownloadLink]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Download zip file related to a specific challenge
